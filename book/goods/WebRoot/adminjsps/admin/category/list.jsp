...
<c:forEach items="${parents }" var="parent">  	
    	<tr class="trOneLevel">
    		...
    		<td>${parent.desc }</td>
    		<td width="200px;">
    		  <a href="<c:url value='/admin/AdminCategoryServlet?method=findParent&pid=${parent.cid }'/>">添加二级分类</a>
   ...
   <c:forEach items="${parent.children }" var="child">
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="right">
    		  <a href="<c:url value='/admin/AdminCategoryServlet?method=updateChildPre&pid=${child.cid }'/>">修改</a>
